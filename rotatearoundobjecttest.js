...
function init() {
  ...
  sphereMesh1.add(pivotPoint);
	...
	// Sphere Geometry 2
  sphereGeometry2 = new THREE.CylinderGeometry(1, 20, 75, 5);
  ...
  sphereMesh2.position.set(160, 4, 6);
...
function render() {
  // -------------------------------------
	...
	sphereMesh1.position.x = Math.cos( time * 10 ) * 4;
	sphereMesh1.position.y = Math.cos( time * 7 ) * 2;
	sphereMesh1.position.z = Math.cos( time * 8 ) * 3;
